...
/**
 * OATDA Ad Run #3 (2026-08-29) — based on Run #2, solo grok scaffold.
 ...
 *            4) „OATDA. One API to direct all. oatda.com."
 */
	...
	return (
		...
		>
			<div style={{textAlign: 'center', transform: `translateY(${word}px)`, fontFamily: 'Inter, system-ui, sans-serif'}}>
				...
				<div style={{fontSize: 44, color: ACCENT, fontWeight: 700, marginTop: 20}}>One API to direct all</div>
...
export const GrokAdRun3: React.FC = () => {
	return (
		<AbsoluteFill style={{backgroundColor: '#04070f'}}>
			...
			<Sequence from={HOOK_END} durationInFrames={MODELS_END - HOOK_END}>
				<ShotScene img="images/screenshots/oatda-models.png" nextImg="images/screenshots/oatda-playground-1.png" crossAt={70} />
			</Sequence>
			...
			<Sequence from={MODELS_END} durationInFrames={PLAY_END - MODELS_END}>
				<ShotScene img="images/screenshots/oatda-playground-1.png" nextImg="images/screenshots/oatda-playground-2.png" crossAt={50} />
			</Sequence>
